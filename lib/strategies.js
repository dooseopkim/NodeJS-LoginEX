module.exports = function(app) {
  ...
  const GOOGLE_CREDENTIALS = require("../config/_key.json").google;
  const GITHUB_CREDENTIALS = require("../config/_key.json").github;
  const KAKAO_CREDENTIALS = require("../config/_key.json").kakao;
  const NAVER_CREDENTIALS = require("../config/_key.json").naver;
  const FACEBOOK_CREDENTIALS = require("../config/_key.json").facebook;
