module.exports = {
  ...
  COMMENT_JOIN_USER_SELECT_ALL_WHERE_BOARD_ID:
    "SELECT c.id, u.username, c.modify_date, c.contents, c.like, c.unlike, c.group_seq, c.del_flag FROM comment AS c, users AS u WHERE c.board_id = ? AND c.user_id = u.id ORDER BY c.group_id ASC, c.group_seq ASC;",
